  ...
  _createClass(Composition, [{
    ...
    value: function _transformOperations() {
      ...
      return [{
        ...
        weight: -3,
        func: function func(id, figure) {
          return _this5._removeFromVTree(id, figure);
        }
      }, {
        ...
        weight: -1,
        func: function func(a, b) {
          _this5._removeFromSubsectTree([a.id, b.id], figures.subsect(a.figure, b.figure));
        }
      }, {
    ...
    value: function _removeOperations() {
      ...
      return [{
        ...
        weight: 0,
        func: function func(a, b) {
          _this6._removeFromSubsectTree([a.id, b.id], figures.subsect(a.figure, b.figure), _this6._subsectTree);
        }
      }, {
        description: "Removes old coincident pair records and takes new ones if needed",
        action: "remove",
