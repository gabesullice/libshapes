...
var Composition = function () {
  ...
  _createClass(Composition, [{
    ...
    value: function _getOperations(action) {
      ...
      return [{
        ...
        func: function func(_, figure) {
          ...
          var fids = _this3._getFigureSiblingIds(figure);
          fids.forEach(function (id) {
            _this3._processGaps(id, _this3._figures[id]);
          });
        }
      }, {
        description: "Removes any overlap records for a removed figure",
    ...
    value: function _getFigureSiblingIds(figure) {
      ...
      return figure.edges().reduce(function (all, e0) {

        var vertices = e0.vertices();

        var items = vertices.reduce(function (items, v) {
          var result = _this6._subsectTree.at(v);
        ...
        var siblings = fids.filter(function (fid) {
          return figures.siblings(figure, _this6._figures[fid]);
        });

        all = all.concat(siblings.filter(function (fid) {
          return !all.some(function (id) {
            return id == fid;
          });
        }));
        return all;
    ...
    value: function _addToTree(figure) {
      ...
      figure.edges().forEach(function (e) {
        return _this7._vTree.insertEdge(e, [figure.id]);
      });
    }
  }, {
    key: "_removeFromTree",
