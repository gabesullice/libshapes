...
exports.replay = exports.fromHistory = exports.same = exports.Composition = undefined;
...
var _Vertex = require("../src/Vertex");

var vertex = _interopRequireWildcard(_Vertex);

var _Edge = require("../src/Edge");

var edges = _interopRequireWildcard(_Edge);

var _Figure = require("../src/Figure");
...
var Composition = function () {
  ...
  (0, _createClass3.default)(Composition, [{
    ...
    value: function nonCoincident() {
      ...
      return (0, _keys2.default)(this._figures).map(function (key) {
    ...
    value: function _doOperations(id, figure, operations) {
      ...
      var _loop3 = function _loop3() {
        ...
        if (batch.hasOwnProperty("iterator")) {
          (0, _keys2.default)(_this7._figures).forEach(function (fid) {
...
function same(a, b) {
  ...
  var _loop4 = function _loop4() {
    var figA = figsA.pop();
    var index = figsB.findIndex(function (elem) {
      return figures.same(figA, elem);
    });
    if (index === -1) {
      return {
        v: false
