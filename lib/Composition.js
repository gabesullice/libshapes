  ...
  _createClass(Composition, [{
    ...
    value: function nonIntegrated() {
      ...
      return Object.keys(this._figures).filter(function (id) {
        return !_this2._checkIntegrated(id, _this2.get(id));
      });
    }
  }, {
    key: "nonCoincident",
    value: function nonCoincident() {
      ...
      return Object.keys(this._figures).map(function (key) {
        return { id: key, figure: _this3._figures[key] };
      }).map(function (item) {
        ...
        return item.edges.some(function (e0) {
          ...
          var left = _this3._subsectTree.at(e0.left());
          var right = _this3._subsectTree.at(e0.right());
    ...
    value: function transform(id, _transform, options) {
      ...
      var transformOps = this._getOperations("transform").concat([{
        ...
        func: function func(id) {
          return start = _this4._figures[id].position();
        }
      }, {
        ...
        weight: 0,
        func: function func(id) {
          final = _this4._handleSnap(id, options);
        }
      }]);
        ...
        if (batch.hasOwnProperty("singular")) {
          batch.singular.forEach(function (operation) {
            try {
              ...
              _this5.log("\"" + operation.description + "\" failed with exception:", e.message);
              if (_this5.debug()) throw e;
            }
          });
        }

        if (batch.hasOwnProperty("iterator")) {
          Object.keys(_this5._figures).forEach(function (fid) {
            var curr = _this5._figures[fid];
            if (id != fid) {
    ...
    value: function _getOperations(action) {
      ...
      return [{
        ...
        func: function func(id, figure) {
          return _this6._figures[id] = figure;
        }
      }, {
        ...
        func: function func(a, b) {
          figures.subsect(a.figure, b.figure).forEach(function (section) {
            _this6._subsectTree.insertEdge(section, [a.id, b.id]);
          });
        }
      }, {
        ...
        func: function func(a, b) {
          if (figures.coincident(a.figure, b.figure)) {
            _this6._coincidentPairs.push({ a: a.id, b: b.id });
          }
        }
      }, {
        ...
        func: function func(id, figure) {
          ...
          if (!isInPairs(id, _this6._coincidentPairs)) {
            _this6._floats.push(id);
          } else {
            _this6._floats = _this6._floats.filter(function (fid) {
              return !isInPairs(fid, _this6._coincidentPairs);
            });
          }
        }
      }, {
        ...
        func: function func(id, figure) {
          figure.edges().forEach(function (e) {
            return _this6._vTree.insertEdge(e, [id]);
          });
        }
      }, {
        ...
        weight: 1,
        func: function func(_, figure) {
          _this6._gaps = _this6._gaps.filter(function (gap) {
        ...
        func: function func(id, figure) {
          ...
          _this6._getFigureSiblingIds(figure).filter(function (fid) {
            return fid != id;
          }).forEach(function (fid) {
            _this6._processGaps(fid, _this6.get(fid));
          });
        }
      }, {
    ...
    value: function _transformOperations() {
      ...
      return [{
        ...
        weight: -3,
        func: function func(id, figure) {
          return _this7._removeFromVTree(id, figure);
        }
      }, {
        ...
        func: function func(id, figure) {
          // Gets the figures siblings and processes them for new gaps.
          siblings = _this7._getFigureSiblingIds(figure).filter(function (fid) {
            return fid != id;
          });
        }
      }, {
        ...
        weight: -1,
        func: function func(a, b) {
          _this7._removeFromSubsectTree([a.id, b.id], figures.subsect(a.figure, b.figure));
        }
      }, {
        ...
        weight: -1,
        func: function func(_, figure) {
          return _this7._gaps = _this7._gaps.filter(function (gap) {
        ...
        weight: 1,
        func: function func(id) {
          return _this7._removeIntersections(id);
        }
      }, {
        description: "Removes any intersection records for a removed figure",
        action: "transform",
        ...
        weight: 1.0,
        func: function func(id) {
          var data = _this7._coincidentPairs.reduce(function (data, pair) {
          ...
          _this7._coincidentPairs = data.remaining;
          _this7._floats = _this7._floats.concat(data.unpaired);
        }
      }, {
        description: "Removes old coincident pair records and takes new ones if needed",
        action: "transform",
        ...
        func: function func(a, b) {
          if (figures.coincident(a.figure, b.figure)) {
            _this7._coincidentPairs.push({ a: a.id, b: b.id });
          }
        }
      }, {
        ...
        func: function func(id, figure) {
          ...
          if (!isInPairs(id, _this7._coincidentPairs)) {
            _this7._floats.push(id);
          } else {
            _this7._floats = _this7._floats.filter(function (fid) {
              return !isInPairs(fid, _this7._coincidentPairs);
            });
          }
        }
      }, {
        ...
        func: function func(id, figure) {
          figure.edges().forEach(function (e) {
            return _this7._vTree.insertEdge(e, [id]);
          });
        }
      }, {
        description: "Finds and stores subsected edges created by coincident figures",
        ...
        func: function func(a, b) {
          figures.subsect(a.figure, b.figure).forEach(function (section) {
            _this7._subsectTree.insertEdge(section, [a.id, b.id]);
          });
        }
      }, {
        description: "Finds and stores instersecting figures",
        ...
        func: function func(a, b) {
          if (figures.intersect(a.figure, b.figure)) {
            _this7._intersecting.push({ a: a.id, b: b.id });
          }
        }
      }, {
        ...
        weight: 3,
        func: function func(_, figure) {
          _this7._gaps = _this7._gaps.filter(function (gap) {
            return !figures.overlap(figure, gap);
          });
        }
      }, {
        ...
        func: function func() {
          siblings.forEach(function (siblingId) {
            _this7._processGaps(siblingId, _this7._figures[siblingId]);
          });
        }
      }, {
        ...
        weight: 4,
        func: function func(id, figure) {
          return _this7._processGaps(id, figure);
        }
      }];
    }
  }, {
    ...
    value: function _removeOperations() {
      ...
      return [{
        ...
        func: function func(id, figure) {
          // Gets the figures siblings and processes them for new gaps.
          siblings = _this8._getFigureSiblingIds(figure).filter(function (fid) {
            return fid != id;
          });
        }
      }, {
        ...
        weight: 0,
        func: function func(id) {
          return _this8._removeIntersections(id);
        }
      }, {
        ...
        weight: 0,
        func: function func(_, figure) {
          return _this8._gaps = _this8._gaps.filter(function (gap) {
            return !figures.coincident(figure, gap);
          });
        }
      }, {
        ...
        weight: 0,
        func: function func(a, b) {
          _this8._removeFromSubsectTree([a.id, b.id], figures.subsect(a.figure, b.figure), _this8._subsectTree);
        }
      }, {
        description: "Removes old coincident pair records and takes new ones if needed",
        action: "remove",
        ...
        weight: 1,
        func: function func(id, figure) {
          var data = _this8._coincidentPairs.reduce(function (data, pair) {
            if (pair.a == id || pair.b == id) {
              var counterpart = pair.a == id ? pair.b : pair.a;
              data.unpaired.push(counterpart);
            } else {
          ...
          _this8._coincidentPairs = data.remaining;
          _this8._floats = _this8._floats.concat(data.unpaired);
        }
      }, {
        ...
        weight: 1,
        func: function func(id) {
          _this8._floats = _this8._floats.filter(function (fid) {
            return fid != id;
          });
        }
      }, {
        ...
        weight: 1,
        func: function func(id, figure) {
          return _this8._removeFromVTree(id, figure);
        }
      }, {
        ...
        func: function func() {
          siblings.forEach(function (siblingId) {
            _this8._processGaps(siblingId, _this8._figures[siblingId]);
          });
        }
      }];
    }
    ...
    value: function _calculateSnap(fig) {
      ...
      fig.vertices().forEach(function (v0) {
        var query = {
          origin: v0,
          radius: _this9._tolerance * _this9._bounds.length()
        };

        var result = _this9._vTree.find(query).map(function (item) {
          return item.vertex;
        });
        if (!result) return;
    ...
    value: function _getFigureSiblingIds(figure) {
      ...
      var items = figure.vertices().reduce(function (items, v) {
        var subsects = _this10._subsectTree.at(v);
        items = subsects ? items.concat(subsects) : items;
        var regulars = _this10._vTree.at(v);
      ...
      return fids.filter(function (fid) {
        return figures.siblings(figure, _this10._figures[fid]);
      });
    }
  }, {
    key: "_getID",
