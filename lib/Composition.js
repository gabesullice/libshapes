  ...
  _createClass(Composition, [{
      ...
      return [{
        ...
        func: function func(a, b) {
          if (figures.coincident(a.figure, b.figure)) {
            _this3._coincidentPairs.push({ a: a.id, b: b.id });
          }
        }
      }, {
        ...
        func: function func(id, figure) {
          ...
          if (!isInPairs(id, _this3._coincidentPairs)) {
            _this3._floats.push(id);
          } else {
            _this3._floats = _this3._floats.filter(function (fid) {
              return !isInPairs(fid, _this3._coincidentPairs);
            });
          }
        }
      }, {
        ...
        func: function func(id, figure) {
          figure.edges().forEach(function (e) {
            return _this3._vTree.insertEdge(e, [id]);
          });
        }
      }, {
        ...
        weight: 1,
        func: function func(id, figure) {
          if (!_this3._checkIntegrated(id, figure)) {
            _this3._nonIntegrated.push(id);
          }

          figure.vertices().map(function (v) {
            return _this3._vTree.at(v);
            ...
            var twin = { a: id, b: tag };
            if (_this3._vertexTwins.findIndex(function (compare) {
              return compare.a == twin.a && compare.b == twin.b || compare.a == twin.b && compare.b == twin.a;
            }) === -1) {
              _this3._vertexTwins.push(twin);
            }
            if (_this3._checkIntegrated(tag, _this3.get(tag))) {
              _this3._nonIntegrated = _this3._nonIntegrated.filter(function (id) {
                return id != tag;
              });
            } else {
              if (_this3._nonIntegrated.findIndex(function (id) {
                return tag == id;
              }) === -1) {
                _this3._nonIntegrated.push(tag);
              }
            }
          });
        }
        ...
        weight: 1,
        func: function func(_, figure) {
          _this3._gaps = _this3._gaps.filter(function (gap) {
        ...
        func: function func(id, figure) {
          ...
          _this3._getFigureSiblingIds(figure).filter(function (fid) {
            return fid != id;
          }).forEach(function (fid) {
            _this3._processGaps(fid, _this3.get(fid));
          });
        }
      }, {
    ...
    value: function _transformOperations() {
      ...
      return [{
        ...
        weight: -3,
        func: function func(id, figure) {
          return _this4._removeFromTree(id, figure);
        }
      }, {
        ...
        weight: -1,
        func: function func(_, figure) {
          return _this4._gaps = _this4._gaps.filter(function (gap) {
        ...
        weight: 1.0,
        func: function func(id) {
          var data = _this4._coincidentPairs.reduce(function (data, pair) {
          ...
          _this4._coincidentPairs = data.remaining;
          _this4._floats = _this4._floats.concat(data.unpaired);
        }
      }, {
        description: "Removes old coincident pair records and takes new ones if needed",
        action: "transform",
        ...
        weight: 2.9,
        func: function func(id, figure) {
          var data = _this4._vertexTwins.reduce(function (data, twin) {
          ...
          data.unpaired.filter(function (tag) {
            return !_this4._checkIntegrated(tag, _this4.get(tag));
          }).forEach(function (tag) {
            if (!_this4._nonIntegrated.some(function (fid) {
              return fid == tag;
            })) {
              _this4._nonIntegrated.push(tag);
            } else {
              _this4._nonIntegrated.filter(function (fid) {
                return fid != tag;
              });
            }
          });

          _this4._vertexTwins = data.remaining;
        }
      }, {
        description: "Records if a figure is not fully integrated (all of its vertices are shared)",
        action: "transform",
        ...
        func: function func(id, figure) {
          if (!_this4._checkIntegrated(id, figure)) {
            ...
            _this4._nonIntegrated = _this4._nonIntegrated.filter(function (fid) {
              return fid != id;
            });
          }
    ...
    value: function _calculateSnap(fig) {
      ...
      fig.vertices().forEach(function (v0) {
        var query = {
          origin: v0,
          radius: _this6._tolerance * _this6._bounds.length()
        };

        var result = _this6._vTree.find(query).map(function (item) {
          return item.vertex;
        });
        if (!result) return;
    ...
    value: function _getFigureSiblingIds(figure) {
      ...
      var items = figure.vertices().reduce(function (items, v) {
        var subsects = _this7._subsectTree.at(v);
        items = subsects ? items.concat(subsects) : items;
        var regulars = _this7._vTree.at(v);
      ...
      return fids.filter(function (fid) {
        return figures.siblings(figure, _this7._figures[fid]);
      });
    }
  }, {
    key: "_getID",
