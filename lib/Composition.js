  ...
  _createClass(Composition, [{
    ...
    value: function nonCoincident() {
      ...
      return Object.keys(this._figures).map(function (key) {
        return { id: key, figure: _this2._figures[key] };
      }).map(function (item) {
        ...
        return item.edges.some(function (e0) {
          ...
          var left = _this2._subsectTree.at(e0.left());
          var right = _this2._subsectTree.at(e0.right());
    ...
    value: function transform(id, _transform, options) {
      ...
      var transformOps = this._getOperations("transform").concat([{
        ...
        func: function func(id) {
          return start = _this3._figures[id].position();
        }
      }, {
        ...
        weight: 0,
        func: function func(id) {
          final = _this3._handleSnap(id, options);
        }
      }]);
        ...
        if (batch.hasOwnProperty("singular")) {
          batch.singular.forEach(function (operation) {
            try {
              ...
              _this4.log("\"" + operation.description + "\" failed with exception:", e.message);
              if (_this4.debug()) throw e;
            }
          });
        }

        if (batch.hasOwnProperty("iterator")) {
          Object.keys(_this4._figures).forEach(function (fid) {
            var curr = _this4._figures[fid];
            if (id != fid) {
    ...
    value: function _getOperations(action) {
      ...
      return [{
        ...
        func: function func(id, figure) {
          return _this5._figures[id] = figure;
        }
      }, {
        ...
        func: function func(id, figure) {
          ...
          _this5._getFigureSiblingIds(figure).filter(function (fid) {
            return fid != id;
          }).forEach(function (fid) {
            _this5._processGaps(fid, _this5.get(fid));
          });
        }
      }, {
    ...
    value: function _transformOperations() {
      ...
      return [{
        ...
        weight: -3,
        func: function func(id, figure) {
          return _this6._removeFromVTree(id, figure);
        }
      }, {
        ...
        weight: -1,
        func: function func(a, b) {
          _this6._removeFromSubsectTree([a.id, b.id], figures.subsect(a.figure, b.figure));
        }
      }, {
        ...
        weight: 3,
        func: function func(id, figure) {
          if (!_this6._checkIntegrated(id, figure)) {
            _this6._nonIntegrated.push(id);
          } else {
          ...
          figure.vertices().map(function (v) {
            ...
            var twin = { a: id, b: tag };
            if (_this6._vertexTwins.findIndex(function (compare) {
              return compare.a == twin.a && compare.b == twin.b || compare.a == twin.b && compare.b == twin.a;
            }) === -1) {
              _this6._vertexTwins.push(twin);
            }
            if (_this6._checkIntegrated(tag, _this6.get(tag))) {
              _this6._nonIntegrated = _this6._nonIntegrated.filter(function (id) {
                return id != tag;
              });
            } else {
              if (_this6._nonIntegrated.findIndex(function (id) {
                return tag == id;
              }) === -1) {
                _this6._nonIntegrated.push(tag);
              }
        ...
        weight: 4,
        func: function func(id, figure) {
          return _this6._processGaps(id, figure);
        }
      }];
    }
  }, {
    ...
    value: function _removeOperations() {
      ...
      return [{
        ...
        weight: 0,
        func: function func(a, b) {
          _this7._removeFromSubsectTree([a.id, b.id], figures.subsect(a.figure, b.figure), _this7._subsectTree);
        }
      }, {
        description: "Removes old coincident pair records and takes new ones if needed",
        action: "remove",
        ...
        weight: 2,
        func: function func(id, figure) {
          var data = _this7._vertexTwins.reduce(function (data, twin) {
            if (twin.a == id || twin.b == id) {
              var counterpart = twin.a == id ? twin.b : twin.a;
              data.unpaired.push(counterpart);
            } else {
          ...
          data.unpaired.filter(function (tag) {
            return !_this7._checkIntegrated(tag, _this7.get(tag));
          }).forEach(function (tag) {
            if (!_this7._nonIntegrated.some(function (fid) {
              return fid == tag;
            })) {
              _this7._nonIntegrated.push(tag);
            } else {
              _this7._nonIntegrated.filter(function (fid) {
                return fid != tag;
              });
            }
          });

          _this7._nonIntegrated = _this7._nonIntegrated.filter(function (fid) {
            return fid != id;
          });
          _this7._vertexTwins = data.remaining;
        }
      }, {
    ...
    value: function _calculateSnap(fig) {
      ...
      fig.vertices().forEach(function (v0) {
        var query = {
          origin: v0,
          radius: _this8._tolerance * _this8._bounds.length()
        };

        var result = _this8._vTree.find(query).map(function (item) {
          return item.vertex;
        });
        if (!result) return;
    ...
    value: function _getFigureSiblingIds(figure) {
      ...
      var items = figure.vertices().reduce(function (items, v) {
        var subsects = _this9._subsectTree.at(v);
        items = subsects ? items.concat(subsects) : items;
        var regulars = _this9._vTree.at(v);
      ...
      return fids.filter(function (fid) {
        return figures.siblings(figure, _this9._figures[fid]);
      });
    }
  }, {
    key: "_getID",
