...
var Composition = function () {
  ...
  _createClass(Composition, [{
    ...
    value: function _processGaps(figure) {
      ...
      if (lonely.length > 0) {
        return lonely.reduce(function (gaps, edge) {
          var gap0 = _this._walkGap([edge.right(), edge.left()], edge.left(), 0);
